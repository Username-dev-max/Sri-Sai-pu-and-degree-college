...
const BLANK = { team: "", name: "", department: "", year: "", role: "", email: "", photoUrl: "" };
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        <p className="text-sm" style={{ color: "var(--color-text-secondary)" }}>
          Members shown here appear on each team's public page under Developed By.
        </p>

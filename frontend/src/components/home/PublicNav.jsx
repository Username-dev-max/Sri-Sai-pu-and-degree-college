...
import { Menu, X, Search, Sun, Moon, GraduationCap, LogIn } from "lucide-react";
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-[72px] flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <div className="hidden lg:flex items-center relative min-w-0 flex-1 max-w-[180px] xl:max-w-[220px]">

...
import {
  ...
  ListChecks, CalendarOff, SlidersHorizontal,
} from "lucide-react";
...
const MENUS = {
  Admin: [
    ...
    { to: "/admin/attendance", label: "Mark Attendance", icon: CalendarCheck, end: true },
    { to: "/admin/attendance/registers", label: "Attendance Management", icon: ListChecks },
    { to: "/admin/attendance/reports", label: "Attendance Reports", icon: BarChart3 },
    { to: "/admin/internal-marks", label: "Internal Marks", icon: Award },
    { to: "/admin/leave-requests", label: "Leave Requests", icon: CalendarOff },
    ...
    { to: "/admin/academic-policies", label: "Academic Policies", icon: SlidersHorizontal },
    { to: "/admin/audit", label: "Audit Log", icon: ScrollText },
  ],
  Faculty: [
    { to: "/faculty", label: "Dashboard", icon: LayoutDashboard, end: true },
    { to: "/faculty/attendance", label: "Mark Attendance", icon: CalendarCheck, end: true },
    { to: "/faculty/attendance/registers", label: "Attendance Management", icon: ListChecks },
    { to: "/faculty/report", label: "Attendance Reports", icon: BarChart3 },
    { to: "/faculty/internal-marks", label: "Internal Marks", icon: Award },
    { to: "/faculty/leave-requests", label: "Leave Requests", icon: CalendarOff },
  ...
  "Attendance Staff": [
    ...
    { to: "/attendance-staff/registers", label: "Attendance Management", icon: ListChecks },
  ...
  Parent: [
    ...
    { to: "/parent/internal-marks", label: "Internal Marks", icon: Award },
    { to: "/parent/leave", label: "Leave Requests", icon: CalendarOff },
  ...
  Student: [
    ...
    { to: "/student/internal-marks", label: "Internal Marks", icon: Award },
    { to: "/student/leave", label: "Leave Requests", icon: CalendarOff },
    { to: "/student/results", label: "Marks & Results", icon: ClipboardList },
